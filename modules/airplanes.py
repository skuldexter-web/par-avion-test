...
def run(stdscr, ref_lat: Optional[float] = None, ref_lon: Optional[float] = None) -> None:
    ...
    radar_win = curses.newwin(radar_h - contact_panel_h, left_w, 0, 0)
    contacts_win = curses.newwin(contact_panel_h, left_w, radar_h - contact_panel_h, 0)
    ...
    sweep = radar_ui.RadarSweep(radar_h - contact_panel_h, left_w, radar_ui.PAIR_GREEN)
    contact_panel = radar_ui.ContactListPanel(contact_panel_h, left_w, radar_ui.PAIR_GREEN)
