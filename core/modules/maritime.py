...
def run(stdscr, ref_lat: Optional[float] = None, ref_lon: Optional[float] = None) -> None:
    ...
    radar_h = height - 1
    contact_panel_h = 8
    sweep = radar_ui.RadarSweep(radar_h - contact_panel_h, width // 2, radar_ui.PAIR_BLUE)
    contact_panel = radar_ui.ContactListPanel(contact_panel_h, width // 2, radar_ui.PAIR_BLUE)
    ...
    radar_win = curses.newwin(radar_h - contact_panel_h, width // 2, 0, 0)
    contacts_win = curses.newwin(contact_panel_h, width // 2, radar_h - contact_panel_h, 0)
    ...
    try:
        while True:
            ...
            contact_panel.draw(contacts_win, contacts, gps_available=gps_available,
                                title="VESSELS")
